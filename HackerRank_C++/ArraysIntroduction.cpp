...
Input Format:
-------------
    The first line of the input contains ,where  is the number of integers.
...
int main() {
    ...
    //  Number of elements n from user.
    int size;          
    cin >> size;
    
    //  create array and take elements from user.
    int arr[size] = {};
